...
```vim
:MasonInstall angular-language-server clang-format clangd codelldb cmakelang cmakelint json-lsp lua-language-server markdownlint-cli2 markdown-toc marksman neocmakelsp basedpyright ruff shfmt sqlfluff stylua taplo tree-sitter-cli vtsls yaml-language-server
```
